...
try:
    ...
    # [NOVO] Lendo o novo arquivo com detalhes da rede (pesos e bias)
    ...
    # [AJUSTE] Corrigido o nome do arquivo de acurácia
...
class PDF(FPDF):
    def header(self):
        ...
        if self.page_no() == 1:
            ...
            self.cell(0, 10, 'Relatório de Treinamento de Rede Neural Convolucional (CNN) para identificar Algarismos', 
...
NOME_ARQUIVO_PDF = 'relatorio_treinamento_algarismos.pdf'
